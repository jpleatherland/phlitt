...
class _MyHomePageState extends State<MyHomePage> {
  late Future<CollectionGroup> collectionsFuture;
  ...
  void initState() {
    super.initState();
    if (!kIsWeb) {
      collectionsFuture = widget.collections.readCollectionsFile(false);
    }
  }
                ...
                builder: (context, snapshot) {
                  if (!snapshot.hasData) {
                    ...
                    return CollectionsPage(
                      collectionGroups: snapshot.data!,
                      manager: widget.collections,
                    );
                  }
                },
              ),
